...
require("plyr")
require("rgeos")
finalresultsprerandomize <- read.csv("/media/stathis/Maxtor/georeference/kalamos/kalamos_prerandomized.csv")

finalresultsprerandomize <- subset(finalresultsprerandomize, y > 0)
#load kallikratis shapefile
greece.map <- readOGR(dsn = "/media/stathis/Maxtor/georeference/shapefiles", layer = "kallikratis-wgs84-utf8")
...
write.csv(randompoints, file = "/media/stathis/Maxtor/georeference/kalamos/randompointswithoutvalues.csv")
...
write.csv(finalresultsprerandomize, file = "/media/stathis/Maxtor/georeference/kalamos/kalamos.randomized.final.csv")
