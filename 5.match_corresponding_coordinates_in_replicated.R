...
#kalamos.repl <- read.csv("/media/stathis/Maxtor/article/georeference/kalamos/processed/kalamos.dec.csv")
...
write.csv(kalamos.repl, file="/media/stathis/Maxtor/article/georeference/kalamos/processed/kalamos.replicated.matched.csv")
