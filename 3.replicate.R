...
View(kalamos[1:10, ])
kalamos <- read.csv("/media/stathis/Maxtor/data/kalamos-initialxy.csv", encoding = "UTF-8")
...
#export as csv
write.csv(kalamos.int, file = "/media/stathis/Maxtor/article/georeference/kalamos/processed/kalamos.int.csv")
write.csv(kalamos.dec, file = "/media/stathis/Maxtor/article/georeference/kalamos/processed/kalamos.dec.csv")
